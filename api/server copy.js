...
const limiter = rateLimit({
    ...
    legacyHeaders: false,
    message: 'Muitas requisições deste IP, por favor, tente novamente após 15 minutos.' // Mensagem de erro
});

const app = express();
app.use(limiter); // <-- Aplica o limitador a todas as requisições
